  ...
  <div class="sections desktop">
    ...
    <div class="center">
      <ul class="menu uppercase">
        ...
        <li><a href="member">로그인|회원가입</a></li>
        <li><a href="#">판매자페이지</a></li>
      </ul>
    </div>
    <div class="right">
      <ul class="menu trim">
...
<section class="slide fade-6 kenBurns">
  ...
  <div class="background" style="background-image:url(../resources/assets/img/background/img-09.jpg)"></div>
</section>
...
<section class="slide fade-6 kenBurns fromLeft">
  ...
  <div class="background" style="background-image:url(../resources/assets/img/background/img-15.jpg)"></div>
</section>
...
<section class="slide fade-6 kenBurns fromRight">
  ...
  <div class="background" style="background-image:url(../resources/assets/img/background/img-14.jpg)"></div>
</section>
...
<section class="slide fade-6 kenBurns">
          ...
          <ul class="flex left">
            ...
            <li class="col-5-12 bottom">
              <div class="videoThumbnail shadow rounded popupTrigger margin-bottom-3 ae-7" data-popup-id="89-3">
                <img src="../resources/assets/img/image-89-1.jpg" class="wide" alt="Video Thumbnail"/>
              </div>
              <img src="../resources/assets/img/image-89-2.jpg" data-action="zoom" class="shadow rounded ae-8" alt="Image"/>
            </li>
          </ul>
        </div>
  ...
  <div class="background" style="background-image:url(../resources/assets/img/background/img-89.jpg)"></div>
</section>
...
<section class="slide fade-6 kenBurns">
  ...
  <div class="background" style="background-image:url(../resources/assets/img/background/img-95.jpg)"></div>
</section>
